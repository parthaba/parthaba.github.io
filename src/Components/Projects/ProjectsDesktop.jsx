  ...
  return (
    <div className="projects">
      <div className="left-box">
        ...
        <div className="projects-item projects-title hhtrigger">
          <HartHouse />
        </div>
        <div className="projects-item projects-title tatrigger">
          <AutoTrader />
        </div>
        <div className="projects-item projects-title webtrigger">
          <Personal />{" "}
        </div>
        <div className="projects-item projects-title pawtrigger">
          <Pawpularity />
        </div>
      </div>

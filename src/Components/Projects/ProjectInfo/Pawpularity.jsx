        ...
        <div className="project-info">
          <div className="proj-title-div">
            ...
            <a
              target={"_blank"}
              rel="noreferrer"
              href="https://github.com/gnguralnick/learnai-pawpularity"
            >
              <img
                className="git-icon"
          ...
          <div className="project-information">
            <ul>
              <li>
                Part of an AI based{" "}
                <a href="https://www.kaggle.com/c/petfinder-pawpularity-score">
                  kaggle competition
                </a>{" "}
              </li>
              <li>
                Created an AI to determine the cuteness of an animal to aid
                animal shelters in taking the best photos
              </li>
